...
class ArrayMapper implements MapperInterface
{
    ...
    public function fetch($id)
    {
        ...
        if (! array_key_exists($id, $this->data)) {
            throw new DomainException('Expense annotation not found', 404);
        }
    ...
    public function update($id, $data)
    {
        ...
        if (! array_key_exists($id, $this->data)) {
            throw new DomainException('Cannot update; no such expense annotation', 404);
        }
    ...
    public function delete($id)
    {
        ...
        if (! array_key_exists($id, $this->data)) {
            throw new DomainException('Cannot delete; no such expense annotation', 404);
        }
